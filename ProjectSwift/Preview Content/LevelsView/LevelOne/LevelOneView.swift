    ...
    var body: some View {
        ZStack {
            ...
            Image("plastic")
                    .resizable()
                    .scaledToFit()
                    .frame(width: UISW * 0.12)
                    .position(x: UISW * 0.85, y: UISH * 0.57)

            Image("glass")
                .resizable()
                .scaledToFit()
                .frame(width: UISW * 0.10)
                .position(x: UISW * 0.15, y: UISH * 0.611)
            ...
            DraggableItemView(
                imageName: "cup",
                start: CGSize(width: UISW * 0.10, height: UISH * 0.027),
                targetPosition: CGPoint(x: UISW * 0.15, y: UISH * 0.60),
                size: UISW * 0.05,
